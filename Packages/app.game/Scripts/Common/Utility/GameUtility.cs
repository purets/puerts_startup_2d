...
public class GameUtility
{
    ...
    public static bool SafeWriteAllBytes(string outFile, byte[] outBytes)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeWriteAllBytes failed! path = {0} with err = {1}", outFile, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeWriteAllLines(string outFile, string[] outLines)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeWriteAllLines failed! path = {0} with err = {1}", outFile, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeWriteAllText(string outFile, string text)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeWriteAllText failed! path = {0} with err = {1}", outFile, ex.Message));
            return false;
        }
    }
    ...
    public static byte[] SafeReadAllBytes(string inFile)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeReadAllBytes failed! path = {0} with err = {1}", inFile, ex.Message));
            return null;
        }
    }
    ...
    public static string[] SafeReadAllLines(string inFile)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeReadAllLines failed! path = {0} with err = {1}", inFile, ex.Message));
            return null;
        }
    }
    ...
    public static string SafeReadAllText(string inFile)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeReadAllText failed! path = {0} with err = {1}", inFile, ex.Message));
            return null;
        }
    }
    ...
    public static bool SafeClearDir(string folderPath)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeClearDir failed! path = {0} with err = {1}", folderPath, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeDeleteDir(string folderPath)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeDeleteDir failed! path = {0} with err: {1}", folderPath, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeDeleteFile(string filePath)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeDeleteFile failed! path = {0} with err: {1}", filePath, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeRenameFile(string sourceFileName, string destFileName)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeRenameFile failed! path = {0} with err: {1}", sourceFileName, ex.Message));
            return false;
        }
    }
    ...
    public static bool SafeCopyFile(string fromFile, string toFile)
    {
        ...
        {
            Logger.Logger.LogError(string.Format("SafeCopyFile failed! formFile = {0}, toFile = {1}, with err = {2}",
