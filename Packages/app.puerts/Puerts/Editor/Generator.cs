...
namespace Puerts.Editor
{
    public class Generator
    {
        ...
        public static void GenerateCode()
        {
            ...
            var saveTo = Path.Combine(Configure.GetCodeOutputDirectory(),"Scripts/") ;
        ...
        public static void GenerateCode(string saveTo, bool tsOnly = false)
        {
            ...
            using (var jsEnv = new JsEnv())
            {
                ...
                using (StreamWriter textWriter = new StreamWriter(Path.Combine(saveTo , "../Typing/csharp/index.d.ts") , false, Encoding.UTF8))
                {
