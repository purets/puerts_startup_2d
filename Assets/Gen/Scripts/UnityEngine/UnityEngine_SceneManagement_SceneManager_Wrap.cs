    ...
    public static class UnityEngine_SceneManagement_SceneManager_Wrap
    {
            ...
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.SceneManagement.CreateSceneParameters), false, false))
                    {
                        
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.Get<UnityEngine.SceneManagement.CreateSceneParameters>(false);
            ...
            try
            {
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = (UnityEngine.SceneManagement.LoadSceneMode)argHelper1.GetInt32(false);
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.SceneManagement.LoadSceneParameters), false, false))
                    {
                        
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.Get<UnityEngine.SceneManagement.LoadSceneParameters>(false);
        ...
        private static void F_UnloadSceneAsync(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.SceneManagement.Scene), false, false))
                    {
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = (UnityEngine.SceneManagement.UnloadSceneOptions)argHelper1.GetInt32(false);
        ...
        private static void A_sceneLoaded(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                UnityEngine.SceneManagement.SceneManager.sceneLoaded += argHelper.Get<UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene, UnityEngine.SceneManagement.LoadSceneMode>>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        private static void A_sceneUnloaded(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.SceneManagement.SceneManager.sceneUnloaded += argHelper.Get<UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene>>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        private static void A_activeSceneChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.SceneManagement.SceneManager.activeSceneChanged += argHelper.Get<UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene, UnityEngine.SceneManagement.Scene>>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
