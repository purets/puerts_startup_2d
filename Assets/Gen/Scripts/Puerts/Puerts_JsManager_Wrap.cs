...
{
    public static class Puerts_JsManager_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new Puerts.JsManager();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Puerts.JsManager), result);
                    }
                }
        ...
        private static void M_GetJsEnv(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.JsManager;
