...
{
    public static class Framework_Network_TCP_TService_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new Framework.Network.TCP.TService();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Framework.Network.TCP.TService), result);
                    }
                }
        ...
        private static void M_GetChannel(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Framework.Network.TCP.TService;
        ...
        private static void S_MemoryStreamManager(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                obj.MemoryStreamManager = argHelper.Get<Common.RecyclableMemoryStream.RecyclableMemoryStreamManager>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        private static void S_needStartSendChannel(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Framework.Network.TCP.TService;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.needStartSendChannel = argHelper.Get<System.Collections.Generic.List<long>>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
