    ...
    public static class NiceTS_ResourceManager_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(ResourceManager), result);
                    }
                }
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        ResourceManager.ReleaseFGUIPackage(Arg0);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = ResourceManager.LoadFairyGUIPackage(Arg0,Arg1);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = ResourceManager.PreadloadFB(Arg0);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = ResourceManager.PreloadJS(Arg0);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = ResourceManager.LoadPrefab(Arg0);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = ResourceManager.LoadTextAsset(Arg0);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = ResourceManager.LoadTextBytes(Arg0);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = ResourceManager.LoadSprite(Arg0);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        ResourceManager.ReleaseAddressGO(Arg0);
        ...
        private static void G_OnFBLoadedHandle(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = ResourceManager.OnFBLoadedHandle;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void S_OnFBLoadedHandle(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                ResourceManager.OnFBLoadedHandle = argHelper.Get<System.Action<string, byte[]>>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
